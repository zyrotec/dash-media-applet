export enum MPRIS_CHANGED_SIGNALS {
    playerConnected = "mpris-player-connected",
    playerDisconnected = "mpris-player-disconnected",
    metadataChanged = "mpris-metadata-changed",
